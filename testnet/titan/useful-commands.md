...
0gchaind tx distribution withdraw-rewards $(0gchaind keys show wallet --bech val -a) --from wallet --gas="auto" --gas-adjustment=1.4 --commission -y

# Delegate yourself (this is how 1 coin is sent)
0gchaind tx staking delegate $(0gchaind keys show wallet --bech val -a) 1000000ua0gi --from wallet --gas="auto" --gas-adjustment=1.4 -y

# Redelegate to other validator
0gchaind tx staking redelegate $(0gchaind keys show wallet --bech val -a) <dst-validator-addr> 1000000ua0gi --from wallet --gas="auto" --gas-adjustment=1.4 -y

# unbond 
0gchaind tx staking unbond $(0gchaind keys show wallet --bech val -a) 1000000ua0gi --from wallet --gas="auto" --gas-adjustment=1.4 -y
...
# Check voting result
0gchaind q gov proposals --voter $(0gchaind keys show wallet -a)
